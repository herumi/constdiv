...
# Class `ConstDivModGen`
- The class `ConstDivModGen`, defined in [constdiv.hpp](https://github.com/herumi/constdiv/blob/main/include/constdiv.hpp), generates optimized code for integer division with a given divisor.
